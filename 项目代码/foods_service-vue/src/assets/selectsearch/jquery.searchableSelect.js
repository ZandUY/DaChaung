  ...
  $sS.fn.extend({
    init: function(list){
      ...
      var pwidth = $(this.element[0]).css("width");
	    var pheight = $(this.element[0]).css("height");
      this.searchableElement = $('<div tabindex="0" class="searchable-select '+this.element.attr("id")+'-selectable" style="width:100%;height:'+pheight+'"></div>');
      this.holder = $('<div class="searchable-select-holder" style="height:'+pheight+'"></div>');
