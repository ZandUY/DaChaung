	...
	<div style="padding:20px;width:80%;margin-left:10%">
		<div style="padding:20px;padding-left:50px;padding-right:50px;border-radius: 10px;margin-top:10px;background-color: white;min-height:350px;">
			...
			<div style="display:flex">
				<div style="flex:2">
					<div style="margin-top:20px;">
						<img :src="''+xtIntroMsgDetail.fmImg+''" style="width: 250px; height: 250px;border-radius: 10px;">
						</div>
					</div>
					<div style="flex:10;margin-left:20px;">
						<div style="margin-top:20px;margin-left:30px;">
							<h2 style="margin-bottom:20px;">{{xtIntroMsgDetail.title}}</h2>
							<div style="display:flex;margin-top:20px;">
								<div style="flex:3;color:gray">联系电话：</div>
								<div style="flex:11;color:gray">
									{{xtIntroMsgDetail.celphone}}
								</div>
							</div>
							<div style="display:flex;margin-top:20px;">
								<div style="flex:3;color:gray">地址：</div>
								<div style="flex:11;color:gray">
									{{xtIntroMsgDetail.address}}
								</div>
							</div>
							<div style="display:flex;margin-top:20px;">
								<div style="flex:3;color:gray">邮箱：</div>
								<div style="flex:11;color:gray">
									{{xtIntroMsgDetail.email}}
								</div>
							</div>
						</div>
						<div style="margin-top:20px;">
							<div style="margin-left:30px;">
								...
								<div style="margin-top:20px;">
									<div style="margin-bottom:20px;margin-top:20px;width:100%">
										<h3 style="margin-bottom:10px;color:#f1bc6c;text-align:left">介绍详情</h3>
										<el-divider></el-divider>
										<div style="padding:20px;" v-html="''+xtIntroMsgDetail.introDetail+''">
										</div>
									</div>
								</div>
							</div>
...
export default {
	...
	methods:{
		initData(){
			...
			$.ajax({
				type : 'get',
				url : that.REQUEST_URL+"/index/xt_intro_detail/getData",
				async: false,
				data : {
					id:that.id,
				...
				success : function(result) {
					that.xtIntroMsgDetail = result.xtIntroMsgDetail;
				}
			});
		},
		initAllTab(){
