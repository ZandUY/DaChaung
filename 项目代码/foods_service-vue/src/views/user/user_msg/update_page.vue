...
<template>
	<div class="edit-page-div">
		<div class="box-card">
			<h2 class="edit-page-div-h2">用户-修改</h2>
			...
			<div class="edit-form-div" id="sgForm">
				<div  class="edit-form-name">身高</div>
				<div class="edit-form-div2">
					<div class="edit-form-div3">
						<el-input type="text"  placeholder="请输入身高(请输入数字)" name="sg" v-model="sg" class="" id="sg"></el-input>
					</div>
				</div>
			</div>
			<div class="edit-form-div" id="weightForm">
				<div  class="edit-form-name">体重</div>
				<div class="edit-form-div2">
					<div class="edit-form-div3">
						<el-input type="text"  placeholder="请输入体重(请输入数字)" name="weight" v-model="weight" class="" id="weight"></el-input>
					</div>
				</div>
			</div>
			<div class="edit-form-div" id="ageForm">
				<div  class="edit-form-name">年龄</div>
				<div class="edit-form-div2">
					<div class="edit-form-div3">
						<el-input type="text"  placeholder="请输入年龄" name="age" v-model="age" class="" id="age"></el-input>
					</div>
				</div>
			</div>
			<div class="edit-form-div" id="headImgForm">
				<div  class="edit-form-name">头像</div>
				<div class="edit-form-div2">
					<div class="edit-form-div3">
...
export default {
	...
	methods:{
		getDataList(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+"/user/user_msg/getInitData",
				async: false,
				data : {
		...
		queryDataDetail(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+"/user/user_msg/queryDataDetail",
				async: false,
				data : {
					'id':that.id,
					'loginToken':that.currentLoginToken,
		...
		submitData(){
			...
			$.ajax({
				type : 'post',
				url : this.REQUEST_URL+"/user/user_msg/update_submit",
				async: false,
				data : {
					'id':that.id,
					'name':name,
