...
<template>
	<div>
		<el-container class="layout-container-demo">
			<el-aside>
				<el-scrollbar>
					<h4><a  data-href="/index" data-params="" href="javascript:void(0)" @click="goToPage" >返回首页</a></h4>
					<hr>
						<el-menu  @select="gotoIframePage">
							...
							<el-menu-item :index="'/user/yd_log/list'">
								运动记录
							</el-menu-item>
							<el-menu-item :index="'/user/ys_log/list'">
								饮食记录
							</el-menu-item>
							<el-menu-item :index="'/user/ysjh_msg/list'">
								饮食推荐
							</el-menu-item>
							<el-menu-item :index="'/user/ydjh_msg/list'">
								运动推荐
							</el-menu-item>
							<el-menu-item :index="'/user/ys_collect_msg/list'">
								饮食收藏
							</el-menu-item>
							<el-menu-item :index="'/user/yd_collect_msg/list'">
								运动收藏
							</el-menu-item>
							<el-menu-item :index="'/user/post_msg/list'">
								我的帖子
							</el-menu-item>
							<el-menu-item :index="'/user/dis_msg/list'">
								我的评论
							</el-menu-item>
							<el-menu-item :index="'/user/reply_msg/list'">
								我的回复
							</el-menu-item>
							<el-menu-item :index="'/user/lmsg_suggest_msg/list'">
								留言反馈
							</el-menu-item>
						</el-menu>
					</el-scrollbar>
				...
				<el-container>
					...
					<el-main>
						<el-scrollbar>
							<iframe  id="iframeDom"   src="/home2"></iframe>
						</el-scrollbar>
					</el-main>
				</el-container>
			</el-container>
