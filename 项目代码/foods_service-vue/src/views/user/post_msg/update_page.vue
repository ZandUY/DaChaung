...
<template>
	<div class="edit-page-div">
		<div class="box-card">
			<h2 class="edit-page-div-h2">帖子-修改</h2>
			...
			<div class="edit-form-div" id="subtitleForm">
				<div  class="edit-form-name">副标题</div>
				<div class="edit-form-div2">
					<div class="edit-form-div3">
						<el-input type="textarea" name="subtitle" v-model="subtitle"  id="subtitle" class="input-text-area" ></el-input>
					</div>
				</div>
			</div>
			<div class="edit-form-div" id="postDetailForm">
				<div  class="edit-form-name">帖子详情</div>
				<div class="edit-form-div2">
					<div class="edit-form-div3">
						<div class="editorDiv" id="postDetail" data-id="postDetail"></div>
					</div>
				</div>
			</div>
...
export default {
	...
	mounted() {
		...
		initAllEditor(this.REQUEST_URL,'postDetail');
		that.queryDataDetail();
		setEditorHtml('postDetail',that.postDetail)
	},
	methods:{
		queryDataDetail(){
			var that = this;
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+"/user/post_msg/queryDataDetail",
				async: false,
				data : {
					'id':that.id,
				...
				success : function(result) {
					...
					setEditorHtml('postDetail',result.postDetail)
				}
			});
		},
		submitData(){
			...
			var postDetail = getEditVal('postDetail');
			$.ajax({
				type : 'post',
				url : this.REQUEST_URL+"/user/post_msg/update_submit",
				async: false,
				data : {
					'id':that.id,
					'title':title,
