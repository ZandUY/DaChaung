...
<template>
	<div class="detail-page">
		<div class="detail-page-div">
			<h2 class="detail-page-name">营养小常识</h2>
								...
								<div  class="detail-page-div6">
									<div class="admin-table">
										<div id="detailBody">
											...
											<div   class="admin-table-div">
												<div class="col1">封面图</div>
												<div class="col2">
													<template v-for="item2 in fmImgList">
														<img :src="item2" class="div-img"/>
													</template>
												</div>
											</div>
											<div class="admin-table-div">
												<div class="col1">常识内容</div>
												<div class="col2" v-html="csContent==null?'':csContent"></div>
											</div>
											<div class="admin-table-div">
...
export default {
	...
	methods:{
		queryDataDetail(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+"/admin/yyxcs_msg/getDetailData",
				async: false,
				data : {
					'id':that.id,
				...
				success : function(result) {
					that.title = (result.detail.yyxcsMsg.title==null?'':result.detail.yyxcsMsg.title);
					that.fmImgList = result.detail.fmImgList;
					that.csContent = (result.detail.yyxcsMsg.csContent==null?'':result.detail.yyxcsMsg.csContent);
					that.fbTime = (result.detail.yyxcsMsg.fbTime==null?'':result.detail.yyxcsMsg.fbTime);
				}
			});
		},
	}
