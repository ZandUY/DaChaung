				...
				<el-table
					...
					<el-table-column
						...
						<el-table-column
							...
							<template v-slot="{ row }">
								<el-button
									href="javascript:void(0)" :data-id="row.disMsg.id" @click="del"
	...
	methods:{
		del(e){
			...
			if(r==true){
				$.ajax({
					type : 'get',
					url : this.REQUEST_URL+"/admin/dis_msg/del",
					async: false,
					data : {
		...
		ajaxCount(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+'/admin/dis_msg/queryCount',
				async: false,
				data : {
					"loginToken":that.currentLoginToken,
		...
		ajaxList(page){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+'/admin/dis_msg/queryList',
				async: false,
				data : {
					"page":page,
					"loginToken":that.currentLoginToken,
