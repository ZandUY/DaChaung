...
<template>
	<div class="edit-page-div">
		<div class="box-card">
			<h2 class="edit-page-div-h2">轮播图-修改</h2>
			<div class="edit-form-div" id="bannerForm">
				<div  class="edit-form-name">轮播图</div>
...
export default {
	...
	methods:{
		queryDataDetail(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+"/admin/banner_msg/queryDataDetail",
				async: false,
				data : {
					'id':that.id,
		...
		submitData(){
			...
			$.ajax({
				type : 'post',
				url : this.REQUEST_URL+"/admin/banner_msg/update_submit",
				async: false,
				data : {
					'id':that.id,
					'banner':banner,
