...
<template>
	<div class="edit-page-div">
		<div class="box-card">
			<h2 class="edit-page-div-h2">饮食计划-修改</h2>
			...
			<div class="edit-form-div" id="ynumFwForm">
				<div  class="edit-form-name">饮食热量范围</div>
				<div class="edit-form-div2">
					<div class="edit-form-div3">
...
export default {
	...
	mounted() {
		...
		setSelectableVal('ynumFw',that.ynumFw)
	...
	methods:{
		getDataList(){
			...
			$.ajax({
				...
				success : function(result) {
					...
					that.ynumFwMsgList = result.ynumFwMsgList;
				}
			});
		},
		queryDataDetail(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+"/admin/ysjh_msg/queryDataDetail",
				async: false,
				data : {
					'id':that.id,
					'loginToken':that.currentLoginToken,
		...
		submitData(){
			...
			$.ajax({
				type : 'post',
				url : this.REQUEST_URL+"/admin/ysjh_msg/update_submit",
				async: false,
				data : {
					'id':that.id,
					'jhName':jhName,
