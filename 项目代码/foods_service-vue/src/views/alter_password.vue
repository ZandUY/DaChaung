...
<template>
	<div class="edit-page-div">
		<el-card class="box-card">
			<h2 class="edit-pass-name">修改密码</h2>
			<div class="edit-form-div" >
				<div  class="edit-form-name">旧密码</div>
			...
			<div class="edit-form-div" >
				<div  class="edit-form-name">新密码</div>
				<div class="edit-form-div2">
					<div class="edit-form-div3">
			...
			<div class="edit-page-div-btn">
				<el-button type="primary" @click="alterPassword"  >提交</el-button>
			</div>
		</el-card>
	</div>
</template>
